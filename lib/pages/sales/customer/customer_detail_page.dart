...
class _CustomerDetailPageState extends State<CustomerDetailPage> {
  ...
  Future<void> _confirmDelete() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus customer "${_customer?.nama}"? Tindakan ini tidak dapat dibatalkan.',
  ...
  Future<void> _deleteCustomer() async {
    ...
    final response = await _customerService.deleteCustomer(widget.customerId);
  ...
  Widget _buildHeaderCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppTheme.kotakblue.withOpacity(0.3),
            blurRadius: 20,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                _customer!.nama.isNotEmpty
                    ? _customer!.nama[0].toUpperCase()
                    : '?',
  ...
  Widget _buildCatatanCard() {
    if (_customer!.catatan.isEmpty || _customer!.catatan == '-') {
  ...
  Widget _buildStatusCard() {
    return Container(
      ...
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: _customer!.isActive ? Colors.green[50] : Colors.red[50],
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: _customer!.isActive ? Colors.green[200]! : Colors.red[200]!,
          width: 1,
        ),
      ),
      child: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(
              color: _customer!.isActive ? Colors.green[100] : Colors.red[100],
              borderRadius: BorderRadius.circular(8),
            ),
            child: Icon(
              _customer!.isActive
              ...
              color: _customer!.isActive ? Colors.green[700] : Colors.red[700],
              size: 20,
            ),
          ),
          const SizedBox(width: 12),
