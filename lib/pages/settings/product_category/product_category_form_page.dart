...
class _ProductCategoryFormPageState extends State<ProductCategoryFormPage> {
  ...
  void initState() {
    ...
    _keteranganController = TextEditingController(
      text: widget.category?.keterangan ?? '',
    );
    _catatanController = TextEditingController(
      text: widget.category?.catatan ?? '',
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            _isEditMode ? 'Edit Kategori Produk' : 'Tambah Kategori Baru',
            style: const TextStyle(
              fontSize: 20,
              fontWeight: FontWeight.w800,
              color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
            ...
            label: 'Nama Kategori',
            hint: 'Contoh: Bahan Baku, Konsinyasi',
          ...
          _buildTextField(
            ...
            label: 'Keterangan',
            hint: 'Contoh: Barang titipan dari supplier',
            ...
            child: _isLoading
                ...
                : Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        _isEditMode ? 'Simpan Perubahan' : 'Tambah Kategori',
                        style: const TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 0.3,
